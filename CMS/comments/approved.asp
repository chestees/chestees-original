		  ...
		  <td width="645" valign="top">
			  ...
			  <tr>
				  ...
				  <table border="0" cellspacing="0" cellpadding="4" width="599" align="center">
				  	<tr>
					  <td style="text-align:center;" colspan="2">- <a href="approved.asp">Back to Approved Comments</a> -</td>
					</tr>
<%
OpenDB()
...
<%
	...
	SQL = "SELECT C.Email, P.Comment, P.Rating, P.DatePosted FROM tblComment P INNER JOIN tblCustomer C ON P.CustomerID = C.CustomerID WHERE P.ProductID = " & intProductID & " AND P.Active = 1 ORDER BY P.DatePosted DESC"
...
<%
	'_____________________________________________________________________________________________
	'CREATE THE COMMENTS RECORDSET
	SQL = "SELECT Comment, Rating, DatePosted FROM tblComment WHERE ProductID = " & intProductID & " AND CustomerID = 0 AND Active = 1 ORDER BY DatePosted DESC"
		Set rsComments = Conn.Execute(SQL)
