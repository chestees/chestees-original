...
SQL = "SELECT ContestID, Contest FROM tblContest ORDER BY ContestID"
...
If Not RS.EOF Then
	...
	intContestID = RS("ContestID")
	strContest = RS("Contest")
	i = i+1
	If cColor = "#E2E6EF" Then cColor = "#EEF2FC" Else cColor = "#E2E6EF" End If
%>
					<tr bgcolor="<%=cColor%>">
					  <td><%=i%>. <a class="Record" href="edit.asp?ContestID=<%=intContestID%>"><%=strContest%></a></td>
