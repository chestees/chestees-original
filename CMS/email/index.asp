		  ...
		  <td width="645" valign="top">
			  ...
			  <tr>
				  ...
				  <table border="0" cellspacing="0" cellpadding="0">
				  	<tr>
				  	  <td width="2"><img src="<%=cAdminPath%>images/filler.gif" width="2" height="38"></td>
					  <td width="621" class="PageTitle" align="right">EMAIL SIGN-UPS</td>
...
SQL = "SELECT EmailID, Email FROM tblEmail ORDER BY EmailID DESC"
...
If Not RS.EOF Then
	...
	intEmailID = RS("EmailID")
	strEmail = RS("Email")
	i=i+1
	If cColor = "#E2E6EF" Then cColor = "#EEF2FC" Else cColor = "#E2E6EF" End If
%>
					<tr bgcolor="<%=cColor%>">
					  <td><%=i%>. <span class="PinkB12px"><%=strEmail%></span></td>
