		  ...
		  <td width="645" valign="top">
			  ...
			  <tr>
				  ...
				  <table border="0" cellspacing="0" cellpadding="0">
				  	<tr>
				  	  <td width="2"><img src="<%=cAdminPath%>images/filler.gif" width="2" height="38"></td>
					  <td width="621" class="PageTitle" align="right">MEMBERS LISTING</td>
...
SQL = "SELECT CustomerID, Email, OptIn, JoinDate FROM tblCustomer ORDER BY CustomerID DESC"
...
If Not RS.EOF Then
	...
	strEmail = RS("Email")
	blnOptIn = RS("OptIn")
	dtJoinDate = RS("JoinDate")
	
	If cColor = "#E2E6EF" Then cColor = "#EEF2FC" Else cColor = "#E2E6EF" End If
%>
					<tr bgcolor="<%=cColor%>">
					  <td><%=i%>. <span class="PinkB12px"><%=strEmail%></span><br><b>Opted In:</b> <%=blnOptIn%>&nbsp&nbsp;<b>Joined:</b> <%=dtJoinDate%></td>
