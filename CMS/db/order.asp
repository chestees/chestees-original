		  ...
		  <td width="645" valign="top">
			  ...
			  <tr>
				  ...
				  <table border="0" cellspacing="0" cellpadding="4" width="599" align="center">
				  	<tr bgcolor="#a13b3b">
					  <td colspan="2" class="White12pxB">Order</td>
					</tr>
<%
OpenDB()
SQL = "SELECT OrderID, CustomerID, VisitorID, ShippingID, BillingID, PaymentID, DateOrdered, Lock FROM tblOrder ORDER BY OrderID DESC"
	...
	Do While Not RS.EOF
		...
		response.Write("<tr><td valign=""top""><a href=""delete.asp?action=4&OrderID="&intOrderID&""">X</a></td>")
		response.Write("<td valign=""top""><b>" & intOrderID & "</b>, C:" & intCustomerID & ", V:" & intVisitorID & ", B:" & intBillingID & ", S:" & intShippingID & ", P:" & intPaymentID & ", " & dtDateOrdered & ", " & blnLock & "</td></tr>")
