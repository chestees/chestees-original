		  ...
		  <td width="645" valign="top">
			  ...
			  <tr>
				  ...
				  <table border="0" cellspacing="0" cellpadding="4" width="599" align="center">
				  	<tr bgcolor="#a13b3b">
					  <td colspan="2" class="White12pxB">Payment</td>
					</tr>
<%
OpenDB()
SQL = "SELECT PaymentID, CustomerID, VisitorID, CardType, CardNumber, ExpMo, ExpYear, CVV, CouponCode, Lock FROM tblPayment ORDER BY PaymentID DESC"
	...
	Do While Not RS.EOF
		...
		strCardType = RS("CardType")
		strCardNumber = RS("CardNumber")
		strExpMo = RS("ExpMo")
		strExpYear = RS("ExpYear")
		strCVV = RS("CVV")
		strCouponCode = RS("CouponCode")
		blnLock = RS("Lock")
		
		response.Write("<tr><td valign=""top""><a href=""delete.asp?action=3&PaymentID="&intPaymentID&""">X</a></td>")
		response.Write("<td valign=""top""><b>" & intPaymentID & "</b>, C:" & intCustomerID & ", V:" & intVisitorID & ", " & strCardType & ", " & strCardNumber & ", " & strExpMo & ", " & strExpYear & ", " & strCVV & ", " & strCouponCode & ", " & blnLock & "</td></tr>")
