		  ...
		  <td width="645" valign="top">
			  ...
			  <tr>
				  ...
				  <table border="0" cellspacing="0" cellpadding="4" width="599" align="center">
				  	<tr bgcolor="#a13b3b">
					  <td colspan="2" class="White12pxB">Shipping</td>
					</tr>
<%
OpenDB()
SQL = "SELECT ShippingID, CustomerID, VisitorID, FName, LName, Address, Address2, City, State, Zip, Lock FROM tblShippingAddress ORDER BY ShippingID DESC"
	...
	Do While Not RS.EOF
		...
		response.Write("<tr><td valign=""top""><a href=""delete.asp?action=2&ShippingID="&intShippingID&""">X</a></td>")
		response.Write("<td valign=""top""><b>" & intShippingID & "</b>, C:" & intCustomerID & ", V:" & intVisitorID & ", " & strB_FName & ", " & strB_LName & ", " & strB_Address & ", " & strB_Address2 & ", " & strB_City & ", " & strB_State & ", " & strB_Zip & ", " & blnLock & "</td></tr>")
