		  ...
		  <td width="645" valign="top">
			  ...
			  <tr>
				  ...
				  <table border="0" cellspacing="0" cellpadding="0">
				  	<tr>
				  	  <td width="2"><img src="<%=cAdminPath%>images/filler.gif" width="2" height="38"></td>
					  <td width="621" class="PageTitle" align="right">CUSTOMER LISTING</td>
...
SQL = "SELECT C.CustomerID, C.Email FROM tblCustomer C INNER JOIN tblOrder O ON C.CustomerID = O.CustomerID WHERE O.Lock = 1 ORDER BY C.CustomerID DESC"
...
%>
					<tr bgcolor="<%=cColor%>">
					  <td><%=i%>. <a class="Record" href="edit.asp?CustomerID=<%=intCustomerID%>"><%=strEmail%></td>
