		  ...
		  <td width="645" valign="top">
			  ...
			  <tr>
				  ...
				  <table border="0" cellspacing="0" cellpadding="0">
				  	<tr>
				  	  <td width="2"><img src="<%=cAdminPath%>images/filler.gif" width="2" height="38"></td>
					  <td width="621" class="PageTitle" align="right">SIZES LISTING</td>
...
SQL = "SELECT ProductSizeID, Size FROM tblProductSize ORDER BY ProductSizeID"
...
%>
					<tr bgcolor="<%=cColor%>">
					  <td><a class="Record" href="edit.asp?ProductSizeID=<%=intProductSizeID%>"><%=strSize%></a></td>
